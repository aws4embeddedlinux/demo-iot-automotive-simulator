...
class World(object):
    ...
    def tick(self, clock):
        ...
        self.can.set_sig('Longitude', self.gnss_sensor.lon)
        self.can.set_sig('AccelerationX', self.imu_sensor.accelerometer[0])
        self.can.set_sig('AccelerationY', self.imu_sensor.accelerometer[1])
        self.can.set_sig('AccelerationZ', self.imu_sensor.accelerometer[2])
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        self._info_text = [
            ...
            'IMU:% 24s' % ('(% 2.6f, % 3.6f)' % (world.imu_sensor.accelerometer[0], world.imu_sensor.accelerometer[1])),
...
class CollisionSensor(object):
    ...
    def _on_collision(weak_self, event):
        ...
        self.history.append((event.frame, self.intensity))
